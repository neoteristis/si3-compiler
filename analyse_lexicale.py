...
class FloLexer(Lexer):
	...
	tokens = { IDENTIFIANT, ENTIER, BOOLEAN, ECRIRE, INFERIEUR_OU_EGAL,SUPERIEUR_OU_EGAL,
			   DIFFERENT, EQUAL, ET, OU, NON, SI, SINON, TANTQUE, RETOURNER , AFFECT, SEPARATOR, LIRE, INT,BOOL}
